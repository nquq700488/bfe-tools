...
import { ALLOWED_FILE_TYPES, MAX_FILE_SIZES, type BackendToolId } from './constants'
 ...
 * @param tool 工具标识
 */
export function validateFileFormat(file: File, tool: BackendToolId): boolean {
 ...
 * @param tool 工具标识
 */
export function validateFileSize(file: File, tool: BackendToolId): boolean {
